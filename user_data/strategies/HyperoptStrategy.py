...
class HyperoptStrategy(IStrategy):
    """
    Stratégie optimisée pour l'hyperopt avec paramètres ajustables
    """
    INTERFACE_VERSION = 3
    ...
    # Timeframes informatifs pour l'analyse multi-timeframe
    ...
    # Trailing stop désactivé pour simplifier
    trailing_stop = False
    ...
    buy_bb_factor = DecimalParameter(0.5, 2.0, default=1.0, space="buy")
    
    buy_adx_min = IntParameter(15, 30, default=20, space="buy")
    buy_mfi_min = IntParameter(20, 40, default=30, space="buy")
    ...
    sell_bb_exit = CategoricalParameter([True, False], default=False, space="sell")
    ...
    def populate_indicators(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        # Bollinger Bands
        bollinger = ta.BBANDS(dataframe, timeperiod=20, nbdevup=float(self.buy_bb_factor.value), nbdevdn=float(self.buy_bb_factor.value))
    ...
    def populate_entry_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        required_columns = ['rsi', 'ema_fast', 'ema_slow', 'bb_percent', 'adx', 'mfi', 'volume_ma']
        for tf in self.informative_timeframes:
        ...
        dataframe.loc[
            (
                ...
                # MFI
                (dataframe['mfi'] > self.buy_mfi_min.value) &
    ...
    def populate_exit_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        dataframe.loc[
            (
                ...
                (self.sell_bb_exit.value & (dataframe['close'] > dataframe['bb_upperband'])) |
